...
class SubtractOperation(Command):
    def execute(self, *args, **kwargs):
        """Prompts the user for two numbers, performs subtraction, and prints the result."""
        try:
            ...
            logging.info(f'Subtraction operation done successfully')
        except ValueError:
            print("Please enter valid numbers.")
            logging.info(f'Subtraction operation failed')
